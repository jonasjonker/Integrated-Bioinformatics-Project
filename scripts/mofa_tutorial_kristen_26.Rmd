...
```{r}
feature_metadata <- fread("C:\\Users\\user\\Desktop\\pbmc_unsorted_3k_filtered_feature_bc_matrix\\filtered_feature_bc_matrix\\features.tsv.gz") %>%
...
```{r}
foo <- fread("C:\\Users\\user\\Desktop\\pre_processed_pbmc_unsorted_3k_atac_peak_annotation_temp.tsv") %>%
  .[,c("peak","peak_type")] %>%
