...
# run parameters
addArchRThreads(threads = 12)     # note that subThreading is disabled in createArrowFiles() 
addArchRGenome("hg38")
...
output_paths <- file.path(args$data_dir, sample_names)
