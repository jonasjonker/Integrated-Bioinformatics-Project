...
#read data
multiome.data = Read10X(data.dir = "C:\\Users\\user\\Desktop\\10xgenomics_data\\10kunsorted\\pbmc_unsorted_10k_filtered_feature_bc_matrix\\filtered_feature_bc_matrix")
...
annotated_Seurat = readRDS("C:\\Users\\user\\Desktop\\10xgenomics_data\\pbmc_10k_v3.rds")
...
write.csv(predictions, file = 'CellType_annotation_pbmc_unsorted_10k.csv', row.names = TRUE)
